            ...
            <div className="flex flex-col justify-between h-full">
              <div className="flex flex-col gap-y-8">
                ...
                <ul className="flex flex-col gap-y-4 text-[15px] text-white/50 font-sans">
                    ...
                    <li><LocalizedClientLink href="/refund-policy" className="hover:text-[#C5A059] transition-colors">Refund &amp; Return Policy</LocalizedClientLink></li>
                </ul>
              </div>
               ...
               <div className="mt-8 md:mt-12 flex items-center gap-x-3">
                  {/* Instagram */}
                  <a href={contactData?.instagram_url || "https://www.instagram.com/pragya.vijh_astrotalks/"} target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/40 hover:border-[#C5A059] hover:text-[#C5A059] transition-all">
                  ...
                  {/* WhatsApp */}
                  <a href={`https://wa.me/${(contactData?.whatsapp || "+919811611341").replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" aria-label="Message us on WhatsApp" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/40 hover:border-[#C5A059] hover:text-[#C5A059] transition-all">
                  ...
                  {/* Facebook */}
                  <a href={contactData?.facebook_url || "https://www.facebook.com/pragyavijh/"} target="_blank" rel="noopener noreferrer" aria-label="Follow us on Facebook" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/40 hover:border-[#C5A059] hover:text-[#C5A059] transition-all">
                  ...
                  {/* Mail */}
                  <a href={`mailto:${contactData?.email || "tbspragya@gmail.com"}`} aria-label="Email us" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/40 hover:border-[#C5A059] hover:text-[#C5A059] transition-all">
