          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-x-12 gap-y-12 md:gap-y-16 mb-8 md:mb-10 mt-4">
            ...
            <div className="flex flex-col justify-between h-full">
              ...
              <div className="mt-8 md:mt-12 flex items-center gap-x-4">
                 {/* Instagram */}
                 <a 
                   href={contactData?.instagram_url || "https://www.instagram.com/pragya.vijh_astrotalks/"} 
                   target="_blank" 
                   rel="noopener noreferrer" 
                   className="w-11 h-11 rounded-full border border-white/10 flex items-center justify-center text-white/40 hover:border-[#C5A059] hover:text-[#C5A059] transition-all"
                   title="Instagram"
                 >
                 ...
                 {/* WhatsApp */}
                 <a 
                   href={`https://wa.me/${(contactData?.whatsapp || "+919811611341").replace(/\+/g, '').replace(/\s/g, '')}`} 
                   target="_blank" 
                   rel="noopener noreferrer" 
                   className="w-11 h-11 rounded-full border border-white/10 flex items-center justify-center text-white/40 hover:border-[#25D366] hover:text-[#25D366] transition-all"
                   title="WhatsApp"
                 >
                 ...
                 {/* Facebook */}
                 <a 
                   href={contactData?.facebook_url || "https://www.facebook.com/pragyavijh/"} 
                   target="_blank" 
                   rel="noopener noreferrer" 
                   className="w-11 h-11 rounded-full border border-white/10 flex items-center justify-center text-white/40 hover:border-[#1877F2] hover:text-[#1877F2] transition-all"
                   title="Facebook"
                 >
                 ...
                 {/* Mail */}
                 <a 
                   href={`mailto:${contactData?.email || "theblissfulsoul27@gmail.com"}`} 
                   className="w-11 h-11 rounded-full border border-white/10 flex items-center justify-center text-white/40 hover:border-[#C5A059] hover:text-[#C5A059] transition-all"
                   title="Email"
                 >
