...
const ShippingAddress = ({
  ...
  return (
    <>
      {customer && (addressesInRegion?.length || 0) > 0 && !isDigitalOnly && (
      ...
      {isDigitalOnly ? (
        ...
        <>
          ...
          <input type="hidden" name="shipping_address.postal_code" value="110001" />
          <input type="hidden" name="shipping_address.city" value="New Delhi" />
          <input type="hidden" name="shipping_address.country_code" value="in" />
          <input type="hidden" name="shipping_address.province" value="Delhi" />
        </>
      ) : null}
